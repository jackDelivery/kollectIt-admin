...
export default function AdminDashboard() {
  ...
  const [NuOfTXN, setNuOfTXN] = useState([]);
  ...
  function TotalNuOfTXN() {
    axios({
      ...
      .then((res) => {
        // console.log(res.data, "Trasaction");
        setNuOfTXN(res.data);
      })
      .catch((err) => {
        console.log(err);
  ...
  console.log(NuOfTXN.length, "NuOfTXNNuOfTXNNuOfTXN");
  return (
          ...
          <Wrap spacing="50px">
            <WrapItem>
              <Stack
                w="180px"
                h="140px"
                backgroundColor="#8EB9BB"
                borderRadius={20}
              >
                <Text
                  h="70px"
                  backgroundColor="#427D8F"
                  borderTopRadius={20}
                  textAlign="center"
                  p={5}
                  fontSize={20}
              ...
              <Box bg="#EDF2F7" borderRadius="2xl" h="100%">
                <VStack>
                  <Wrap bg="#8EB9BB" borderRadius={5} boxShadow="xl" p={2}>
                    <Text textAlign="center" fontSize={22} w={100}>
                      Name
                    </Text>
                    <Text textAlign="center" fontSize={22} w={100}>
                      Amount
